...
true_name = "test a."
driver.find_element_by_xpath("//android.widget.TextView[@text='Выйти из аккаунта']").click()

check_name = driver.find_element_by_xpath("//android.widget.TextView[@text='Добро пожаловать']").text
true_name = 'Добро пожаловать'
