...
driver.find_element_by_id('com.vitacore.vitakit:id/password_edit_text').send_keys('123456789')
driver.find_element_by_id('com.vitacore.vitakit:id/login_button').click()
driver.find_element_by_id('com.vitacore.vitakit:id/login_button').click()


driver.save_screenshot("/Users/Artem.Korol/Downloads/VITAKIT_APP/screenshots/"+"passincorrect"+".png")
tess.pytesseract.tesseract_cmd = r"C:/Program Files/Tesseract-OCR/tesseract.exe"
img = Image.open("/Users/Artem.Korol/Downloads/VITAKIT_APP/screenshots/"+"passincorrect"+".png")
text = tess.image_to_string(img, lang="rus")
searching = re.search(r'Неверный логин', text)
check_name = searching.group(0)
true_name = "Неверный логин"
